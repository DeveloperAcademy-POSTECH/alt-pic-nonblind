...
struct textView_Previews: PreviewProvider {
    static var previews: some View {
        originalView(altImageCommentElement: .constant(AltImageData(imageName: "apple", imageUrl: "https://www.naver.com", altNum: 5,imageComments: CommentDataSample)))
    }
}
